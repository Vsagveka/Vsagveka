...
- Jira, Agile & Gantt-based project planning
...
**Tools:** Python, XGBoost, Data Integration, Agile  
- Analyzed **34,000+ hourly building and weather records** to identify energy drivers  
- Built and validated **XGBoost forecasting model (RMSE: 0.34, R²: 0.60)**  
- Proposed optimization strategies leading to **15% reduction in energy usage**  
- Managed milestones using Agile methods and Gantt charts

---

### 🏙️ NYC Housing Market Analysis
**Tools:** Python (Pandas, NumPy), Geospatial Analysis, Statistics  
- Integrated **property, crime, and transit datasets (4,800+ records)** using Haversine proximity matching  
- Engineered features like **price_per_sqft, felony_share, stations_within_800m**  
- Found **63% variance explained by location & safety factors**, supporting pricing strategy insights  
- Delivered actionable market positioning recommendations

---

### 🛒 Marketplace Risk Analysis & Mitigation (COSO ERM)
**Tools:** Risk Modeling, COSO Framework, Business Analysis  
- Identified **40+ operational, digital, supply chain, and workforce risks** via interviews and field visits  
- Built **Probability × Impact² risk prioritization model** with cost–benefit tie-breakers  
- Designed **Risk Register, Risk Matrix, and KRIs** for proactive monitoring  
- Created disaster recovery and continuity strategies using digital controls

---

### 📰 Fake News Detection System
**Tools:** NLP, Machine Learning, Python  
- Trained **Passive Aggressive and Logistic Regression models** on **30,000+ news articles**  
- Achieved **83% accuracy** and reduced false positives by **25%**  
- Built preprocessing pipelines and explainability reports  
- Led full project documentation and evaluation reporting
...
- Vice President — **iSchool Graduate Organization (ISGO)**
- Graduate Admission Ambassador — Syracuse University
- Smart India Hackathon — Co-developed digital homestay platform for rural tourism
